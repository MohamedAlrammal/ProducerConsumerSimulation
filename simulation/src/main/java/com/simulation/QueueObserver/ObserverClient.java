...
public class ObserverClient {
    public void updatePreQueues(List<Queue> queueList, BlockingQueue<ObjectsAnswer> updatesQueue,Products products){
        ...
        productStation.SetNumofProduct(-1,updatesQueue,products);
        for(Queue q:queueList){
            System.out.println(q.getId()+" "+q.getNoofProducts()+" ");
        }
    }
    public void updateFollQueues(List<Queue> queueList, BlockingQueue<ObjectsAnswer> updatesQueue, Products products){
        ProductStation productStation=new ProductStation();
